// Bare page (no `unstable_instant` config). Under default 'error', implicit
// validation fires on this page in dev AND in build — error level applies
// to both modes. The runtime data accessed at the top of the page is the
